    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <h2>Bienvenido al SISTEMA DE PARQUEO - APPARCAMIENTO</h2>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="btn_registrar_ticket<?php echo $id_map;?>">Registrar entrada</button>
                                                                    <script>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-success" id="btn_facturar<?php echo $id_map;?>">Registrar salida</button>
                                                                    <?php
